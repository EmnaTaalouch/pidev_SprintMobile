...
public class EditEventTypeForm extends BaseForm{
    
    
    Form current;
    public EditEventTypeForm(Resources res,Event_type event ) {
        ...
        btnModifier.addActionListener((e) -> {
            ...
            try {
                ...
                if(libelle.getText().equals("") ) {
                    ...
                    Event_type eventt = new Event_type();
                    
                
                    eventt.setLibelle(libelle.getText());
                   
                    eventt.setId(event.getId());
                    
                    ServiceEventType.getInstance().modifierEvent(eventt);
                   
                    iDialog.dispose();
                    Dialog.show("Update Event Type", "Successfully updated",new Command("OK"));
